    ...
    <el-table :data="conditions.conditionArray" style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="120">
        <template #default="scope">
          <el-button type="text" size="small" @click="deleteCondition(conditions, scope.$index)">删除</el-button>
          <el-button type="text" size="small" @click="updateCondition(conditions, scope.$index)">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-form :model="conditionForm">
      ...
      <template v-for="param in conditionForm.params">
        <el-form-item :label="param.desc + ':'" label-width="140px">
          <el-input-number style="width: 70%" clearable v-model="conditionForm.data[param.name]" v-if="param.type === 'int' || param.type === 'long'"></el-input-number>
