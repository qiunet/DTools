  ...
  setup() {
    ...
    const menus = ref([
      ...
      },
      {
        label: "提交",
        tip: 'SVN提交',
        icon: '<svg focusable="false" class="icon" data-icon="sync" width="1em" height="1em" fill="currentColor" aria-hidden="true" viewBox="64 64 896 896"><path d="M865.04 831.061l-416-128 416-480-544 480-320-128 1024-544-160 800z m-416 192v-224l128 64-128 160z" p-id="5857" fill="#515151"></path></svg>',
        click: () => {
